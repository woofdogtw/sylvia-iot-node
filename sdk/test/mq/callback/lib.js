...
const { ApplicationMgr } = require('../../../mq/callback/application');
const { Connection } = require('../../../mq/callback/lib');
const { NetworkMgr } = require('../../../mq/callback/network');
 ...
 *   @param {CounterConnection} callback.conn
 *
 */
...
function removeRabbitmqQueues(done) {
  function removeQueues(queues, callback) {
    ...
    if (!queue) {
      ...
      return void process.nextTick(() => removeQueues(queues, callback));
    }
